...
/**
 * @file    test_seq_par_2048x2048.cu
 * @author  Alessio Zattoni
 * @date 
 * @brief   Questo file contiene dei test per la versione sequenziale e parallela della cross-correlazione con matrici 2048x2048
 *
 * ...
 */
...
#define SRC_ROWS 2048
#define SRC_COLS 2048
