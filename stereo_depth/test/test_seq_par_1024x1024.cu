...
/**
 * @file    test_seq_par_1024x1024.cu
 * @author  Alessio Zattoni
 * @date 
 * @brief   Questo file contiene dei test per la versione sequenziale e parallela della cross-correlazione con matrici 1024x1024
 *
 * ...
 */
...
#define SRC_ROWS 1024
#define SRC_COLS 1024
