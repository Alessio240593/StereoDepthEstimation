...
int TEST_FAILURES=0;
int TEST_SKIPPED=0;
std::string CURRENT_TESTING_CLASS = "???";
...
bool
check(std::ostream& os, const R& r, const ER& er) {
...
#define TEST_CLASS(classname,testclassconstruct)                       \
    { \
        std::cout << "****************************************\n"       \
                  << "TESTING CLASS " << #classname << "\n"                    \
                  << "****************************************\n" << std::endl; \
        CURRENT_TESTING_CLASS=#classname; \
        testclassconstruct.test(); \
    } \

/*! \brief Print the title for the test case */
#define PRINT_TEST_CASE_TITLE( pTitle )                         \
    {                                                                   \
...
#define PRINT_TEST_COMMENT( pComment )                          \
    {                                                                   \
...
#define TEST_CATCH(message)                                     \
    catch(const std::exception& except) {                                    \
        ++TEST_FAILURES;                                        \
        std::cout << "exception: \"" << except.what() << "\"\n" << std::endl; \
        std::cerr << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << PRETTY_FUNCTION << ": " << message << " throwed \"" << except.what() << "\"." << std::endl;     \
    }                                                                   \
    catch(...) {                                                        \
        ++TEST_FAILURES;                                        \
        std::cout << "unknown exception\n" << std::endl;                \
        std::cerr << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << PRETTY_FUNCTION << ": " << message << " throwed an unknown exception." << std::endl;       \
    }                                                                   \


/*! \brief Calls a function */
#define TEST_CALL(function)                                     \
    {                                                                   \
        std::cout << "****************************************\n"       \
                  << "CALLING " << #function << "\n"                    \
                  << "****************************************\n" << std::endl; \
...
/*! \brief Tries to execute \a statement, writing the statement to standard output. Writes a diagnostic report to standard error if an exception is thrown. <br> <b>Important:</b> Use the TEST_CONSTRUCT() macro if \a statement declares a variable and calls a constructor. */
#define TEST_TRY(statement)                                     \
    {                                                                   \
        std::cout << #statement << ": " << std::flush;                  \
        try {                                                           \
            statement;                                                  \
...
#define TEST_EVALUATE(expression)                               \
    {                                                                   \
        std::cout << #expression << ": " << std::flush;                 \
        try {                                                           \
            std::cout << (expression) << "\n" << std::endl;             \
        }                                                               \
            TEST_CATCH("Expression `" << #expression << "'")    \
        }                                                               \
...
#define TEST_CHECK_WARN(expression,expected)                         \
    {                                                                   \
        std::cout << #expression << ": " << std::flush; \
        Bool ok = check(std::cout,expression,expected);         \
        if(ok) {                                                        \
            std::cout << "\n" << std::endl;                             \
        } else {                                                        \
            std::cout << "\nWARNING: expected " << #expression << " = " << #expected << " == " << (expected) << " \n" << std::endl; \
            std::cerr << "WARNING: " << __FILE__ << ":" << __LINE__ << ": " << PRETTY_FUNCTION << ": Check `" << #expression << "==" << #expected << "' failed; obtained " << (expression) << std::endl; \
        }                                                               \
    }                                                                   \


/*! \brief Evaluates \a expression and checks if the result is equal to \a expected. */
#define TEST_CHECK(expression,expected)                         \
    {                                                                   \
        std::cout << #expression << ": " << std::flush; \
        Bool ok = check(std::cout,expression,expected);         \
        if(ok) {                                                        \
            ...
            std::cerr << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << PRETTY_FUNCTION << ": Check `" << #expression << "==" << #expected << "' failed; obtained " << (expression) << std::endl; \
        }                                                               \
    }                                                                   \


/*! \brief Evaluates \a expression1 and expression2 and checks if the results are equal. */
#define TEST_SAME(expression1,expression2)                         \
    {                                                                   \
        ...
        if(ok) {                                                        \
            ...
            std::cerr << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << PRETTY_FUNCTION << ": Identity `" << #expression1 << " === " << #expression2 << "' failed; " << #expression1 << "=" << (expression1) << "; " << #expression2 << "=" << (expression2) << std::endl; \
        }                                                               \
    }                                                                   \

/*! \brief Evaluates \a expression and checks if the result is the same as \a expected. */
#define TEST_SAME_AS(expression,expected)                         \
    {                                                                   \
        ...
        if(ok) {                                                        \
            ...
            ++TEST_FAILURES;                                    \
            std::cout << "\nERROR: " << #expression << ":\n           " << (expression) << std::endl; \
            std::cerr << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << PRETTY_FUNCTION << ": Sameness of `" << #expression << " and " << #expected << "' failed;" << std::endl; \
...
/*! \brief Evaluates \a expression1 and expression2 and checks if the results are equal. */
#define TEST_EQUAL(expression1,expression2)                         \
    {                                                                   \
        ...
        if(ok) {                                                        \
            ...
            std::cout << "\nERROR: " << #expression1 << ":\n           " << (expression1) \
                      << "\n     : " << #expression2 << ":\n           " << (expression2) << std::endl; \
            std::cerr << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << PRETTY_FUNCTION << ": Equality `" << #expression1 << " == " << #expression2 << "' failed; " << #expression1 << "=" << (expression1) << "; " << #expression2 << "=" << (expression2) << std::endl; \
        }                                                               \
    }                                                                   \

/*! \brief Evaluates \a expression1 and expression2 and checks if the results are not equal. */
#define TEST_NOT_EQUAL(expression1,expression2)                 \
    {                                                                   \
        std::cout << #expression1 << " != " << #expression2 << ": " << std::flush; \
        Bool ok = ((expression1) == (expression2));               \
        if(ok) {                                                        \
            ...
            std::cout << "\nERROR: " << #expression1 << ":\n           " << (expression1) \
                      << "\n     : " << #expression2 << ":\n           " << (expression2) << std::endl; \
            std::cerr << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << PRETTY_FUNCTION << ": Inequality `" << #expression1 << " != " << #expression2 << "' failed; " << #expression1 << "=" << (expression1) << "; " << #expression2 << "=" << (expression2) << std::endl; \
        } else {                                                        \
            std::cout << "true\n" << std::endl;                         \
        }                                                               \
    }                                                                   \
...
/*! \brief Evaluates \a expression and checks if the result is equal to \a expected. */
#define TEST_EQUALS(expression,expected)                         \
    {                                                                   \
        std::cout << #expression << " == " << #expected << ": " << std::flush; \
        ...
        if(ok) {                                                        \
            ...
            ++TEST_FAILURES;                                    \
            std::cout << "\nERROR: " << #expression << ":\n           " << (expression) << std::endl; \
            std::cerr << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << PRETTY_FUNCTION << ": Equality `" << #expression << " == " << #expected << "' failed;" << std::endl; \
            std::cerr << "  " << #expression << "=" << (expression) << std::endl; \
            std::cerr << "  " << #expected << "=" << (expected) << std::endl; \
        }                                                               \
    }                                                                   \
...
#define TEST_WITHIN(expression,expected,tolerance)                         \
    {                                                                   \
        std::cout << #expression << " ~ " << #expected << ": " << std::flush; \
        ...
        if(ok) {                                                        \
            ...
            std::cerr << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << PRETTY_FUNCTION << ": ApproximateTag equality `" << #expression << " ~ " << #expected << "' failed; " << #expression << "=" << (expression) << "; " << #expected << "=" << (expected)<< "; error=" << (error) << "; tolerance=" << (tolerance) << std::endl; \
        }                                                               \
    }                                                                   \
                                                                   \
...
#define TEST_LESS(expression,expected)                         \
    {                                                                   \
        std::cout << #expression << " < " << #expected << ": " << std::flush; \
        Bool ok = ((expression) < (expected));                       \
        if(ok) {                                                        \
            ...
            ++TEST_FAILURES;                                    \
            std::cout << "\nERROR: " << #expression << ":\n           " << (expression) << std::endl; \
            std::cerr << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << PRETTY_FUNCTION << ": Equality `" << #expression << " < " << #expected << "' failed; " << #expression << "=" << (expression) << std::endl; \
        }                                                               \
    }                                                                   \


/*! \brief Evaluates \a predicate(\a argument) and checks if the result is \tt true. */
#define TEST_UNARY_PREDICATE(predicate,argument)    \
    {                                                                   \
        ...
        if(ok) {                                                        \
            ...
            ++TEST_FAILURES;                                    \
            std::cout << "\nERROR: false" << std::endl;                 \
            std::cerr << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << PRETTY_FUNCTION << ": Predicate `" << #predicate << "(" << #argument << ")' with " << #argument << "=" << (argument) << " is false." << std::endl; \
        }                                                               \
    }


/*! \brief Evaluates \a predicate(argument1,argument2) and checks if the result is \tt true. */
#define TEST_BINARY_PREDICATE(predicate,argument1,argument2)    \
    {                                                                   \
        ...
        if(ok) {                                                        \
            ...
            ++TEST_FAILURES;                                    \
            std::cout << "\nERROR: false" << std::endl;                 \
            std::cerr << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << PRETTY_FUNCTION << ": Predicate `" << #predicate << "(" << #argument1 << "," << #argument2 << ")' with\n  " << #argument1 << "=" << (argument1) << ";\n  " << #argument2 << "=" << (argument2) << " is false." << std::endl; \
        }                                                               \
    }


/*! \brief Evaluates \a expression and checks if the result compares correctly with \a expected. */
#define TEST_COMPARE(expression,comparison,expected)           \
    {                                                                   \
        ...
        if(ok) {                                                        \
            ...
            std::cerr << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << PRETTY_FUNCTION << ": Comparison `" << #expression << #comparison << #expected << "' failed; " << #expression << "=" << (expression) << "; " << #expected << "=" << (expected) << std::endl; \
        }                                                               \
    }                                                                   \


/*! \brief Evaluates \a expression, converts to \a Type, and checks if the result compares correctly with \a expected. */
#define TEST_RESULT_COMPARE(Type,expression,comparison,expected) \
    {                                                                   \
        ...
        if(ok) {                                                        \
            ...
            std::cerr << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << PRETTY_FUNCTION << ": Comparison `" << #expression << #comparison << #expected << "' failed; " << #expression << "=" << result << "; " << #expected << "=" << (expected) << std::endl; \
        }                                                               \
    }                                                                   \


/*! \brief Declares an object \a variable of type \a Class (uses the default constructor). */
#define TEST_DECLARE(Class,variable)                            \
    {                                                                   \
...
/*! \brief Constructs object \a variable of type \a Class from \a expression. */
#define TEST_NAMED_CONSTRUCT(Class,variable,expression)               \
    {                                                                   \
        ...
        TEST_CATCH("Named constructor `" << #variable << "=" << #Class << "::" << #expression << "'") \
    }                                                                   \
    Class variable = Class :: expression;                                          \


/*! \brief Construct object \a variable of type \a Class from \a expression using assignment syntax. */
#define TEST_ASSIGN_CONSTRUCT(Class,variable, expression)       \
    {                                                                   \
        std::cout << #Class << " " << #variable << " = " << #expression << ": " << std::flush; \
        try {                                                           \
            Class variable = expression;                                \
        ...
        TEST_CATCH("Assignment `" << #variable << "=" << #expression << "'") \
    }                                                                   \
    Class variable = expression;                                        \

/*! \brief Assigns object \a variable from \a expression. */
#define TEST_ASSIGN(variable, expression)                       \
    {                                                                   \
...
#define TEST_THROWS(statement,error)                             \
    {                                                                   \
        std::cout << #statement << ": " << std::flush;                  \
        try {                                                           \
            statement;                                                  \
            ...
            std::cerr << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << PRETTY_FUNCTION << ": expected " << #error << "; no exception thrown." << std::endl; \
        }                                                               \
            ...
            std::cerr << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << PRETTY_FUNCTION << ": caught exception " << except.what() << "; expected " << #error << std::endl; \
        }                                                               \
    }                                                                   \
...
#define TEST_FAIL(statement)                                    \
    {                                                                   \
        ...
        try {                                                           \
            ...
            std::cerr << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << PRETTY_FUNCTION << ": expected exception; no exception thrown." << std::endl; \
        }                                                               \
        catch(...) {                                                    \
...
#define TEST_STATIC_ASSERT(...)                          \
    {                                                                   \
        ...
        if(result) {                                                    \
            ...
            ++TEST_FAILURES;                                    \
            std::cout << "false\n" << std::endl;                 \
            std::cout << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << __FUNCTION__ << ": " << CURRENT_TESTING_CLASS << ": Static assertion `" << #__VA_ARGS__ << "' failed." << "\n" << std::endl; \
            std::cerr << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << __FUNCTION__ << ": " << CURRENT_TESTING_CLASS << ": Static assertion `" << #__VA_ARGS__ << "' failed." << std::endl; \
        }                                                               \
    }                                                                   \
...
#define TEST_SAME_TYPE(...)                          \
    {                                                                   \
        ...
        if(result) {                                                    \
            ...
            ++TEST_FAILURES;                                    \
            std::cout << "false\n" << std::endl;                 \
            std::cout << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << __FUNCTION__ << ": " << CURRENT_TESTING_CLASS << ": Static assertion `IsSame<" << #__VA_ARGS__ << ">' failed." << " First type is " << class_name<typename First<__VA_ARGS__>::Type>() << "\n" << std::endl; \
            std::cerr << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << __FUNCTION__ << ": " << CURRENT_TESTING_CLASS << ": Static assertion `IsSame<" << #__VA_ARGS__ << ">' failed." << " First type is " << class_name<typename First<__VA_ARGS__>::Type>() << std::endl; \
        }                                                               \
    }                                                                   \
...
#define TEST_EQUIVALENT_TYPE(...)                          \
    {                                                                   \
        ...
        if(result) {                                                    \
            ...
            ++TEST_FAILURES;                                    \
            std::cout << "false\n" << std::endl;                 \
            std::cout << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << __FUNCTION__ << ": " << CURRENT_TESTING_CLASS << ": Static assertion `IsEquivalent<" << #__VA_ARGS__ << ">' failed." << " First type is " << class_name<typename First<__VA_ARGS__>::Type>() << "\n" << std::endl; \
            std::cerr << "ERROR: " << __FILE__ << ":" << __LINE__ << ": " << __FUNCTION__ << ": " << CURRENT_TESTING_CLASS << ": Static assertion `IsEquivalent<" << #__VA_ARGS__ << ">' failed." << " First type is " << class_name<typename First<__VA_ARGS__>::Type>() << std::endl; \
        }                                                               \
    }                                                                   \
 ...
 */
#define TEST_GRID_TREE_SUBPAVING_ITERATOR( expected_result, theGridTreeSubpaving, expected_number_elements ) \
    {                                                                   \
        ...
        for (GridTreeSubpaving::ConstIterator it = theGridTreeSubpaving.begin(), end = theGridTreeSubpaving.end(); it != end; it++, elements_count++) { \
            if( elements_count < expected_number_elements ) {           \
                PRINT_TEST_COMMENT("The next Iterator node is: "); \
                TEST_COMPARE( (*expected_result[elements_count]), == , (*it) ); \
            }                                                           \
        }                                                               \
        PRINT_TEST_COMMENT("Test that we iterated through the right number of nodes"); \
        TEST_EQUAL( elements_count , expected_number_elements ); \
    }                                                                   \


/*! \brief clean std::vector, i.e. delete memory of it's non NULL elements and set them to NULL in the vector */
#define CLEAN_TEST_VECTOR( vector ) \
    { \
